...
class UniqueItemsConverter extends atoum
{
    public function testGetErrors()
    {
        $json = json_decode('{"artist":["A","A"]}');
        $schema = json_decode('{
          "$schema": "http://json-schema.org/schema",
          "type": "object",
          "properties": {
            "artist": { "type": "array", "uniqueItems": true }
          },
          "required": [ "artist" ]
        }');
        ...
        ->string($this->testedInstance->getErrors()[0]->code)->isEqualTo(Error::DATA_VALIDATION_UNIQUEITEMS);
    }
}
