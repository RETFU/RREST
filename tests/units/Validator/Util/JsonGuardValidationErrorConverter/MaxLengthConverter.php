...
class MaxLengthConverter extends atoum
{
    public function testGetErrors()
    {
        $json = json_decode('{"artist":"max"}');
        $schema = json_decode('{
          "$schema": "http://json-schema.org/schema",
          "type": "object",
          "properties": {
            "artist": { "type": "string","maxLength": 1 }
          },
          "required": [ "artist" ]
        }');
        ...
        $this
            ...
            ->string($this->testedInstance->getErrors()[0]->code)->isEqualTo(Error::DATA_VALIDATION_MAXLENGTH);
    }
}